...
* [flexprice checkout create](flexprice_checkout_create.md)	 - Create checkout session
* [flexprice checkout delete](flexprice_checkout_delete.md)	 - Delete checkout session
* [flexprice checkout retrieve](flexprice_checkout_retrieve.md)	 - Get checkout session
