## flexprice subscriptions preview-subscription-plan-change-v2
...
POST /subscriptions/{id}/change/v2/preview
...
```
flexprice subscriptions preview-subscription-plan-change-v2 [flags]
```
...
```
  ...
  -h, --help          help for preview-subscription-plan-change-v2
```
