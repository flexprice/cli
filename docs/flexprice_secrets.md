...
* [flexprice secrets create](flexprice_secrets_create.md)	 - Create a new API key
* [flexprice secrets delete](flexprice_secrets_delete.md)	 - Delete an API key
* [flexprice secrets list](flexprice_secrets_list.md)	 - List API keys
