...
POST /tasks/scheduled/schedule-draft-finalization


```
flexprice scheduled-tasks schedule-draft-finalization [flags]
```
...
```
  ...
  -h, --help          help for schedule-draft-finalization
```
