## flexprice coupon-associations

Which coupons apply to which subscriptions

### Options

```
  -h, --help   help for coupon-associations
```
...
* [flexprice coupon-associations list](flexprice_coupon-associations_list.md)	 - List coupon associations
* [flexprice coupon-associations retrieve](flexprice_coupon-associations_retrieve.md)	 - Get coupon association
