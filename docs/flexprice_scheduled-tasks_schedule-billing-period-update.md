...
POST /tasks/scheduled/schedule-update-billing-period


```
flexprice scheduled-tasks schedule-billing-period-update [flags]
```
...
```
  ...
  -h, --help          help for schedule-billing-period-update
```
