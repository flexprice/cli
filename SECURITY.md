...
Contact: [security@flexprice.io](mailto:security@flexprice.io)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At Flexprice, we consider the security of our systems a top priority. But no
...
- E-mail your findings to [security@flexprice.io](mailto:security@flexprice.io).
